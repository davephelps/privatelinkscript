...
@description('The name of the virtual network subnet to be associated with the Azure Function app private endpoint.')
param functionPrivateEndpointSubnetName string = 'snet-func-private'
...
var functionPrivateEndpointName='privatelink.azurewebsites.net'
...
var planresourceid = '/subscriptions/${subscription().subscriptionId}/resourceGroups/${planResourceGroup}/providers/Microsoft.Web/serverfarms/${functionAppPlanName}'
...
var functionPrivateDnsZoneName='functionprivatelink${environment().suffixes.storage}'
var functionPrivateDnsGroupName='${functionPrivateEndpointName}/mydnsgroupnamefunc'

resource FunctionPrivateEndpoint 'Microsoft.Network/privateEndpoints@2022-01-01' = {
...
resource functionPrivateDnsZoneLink 'Microsoft.Network/privateDnsZones/virtualNetworkLinks@2020-06-01' = {
  ...
  name: '${functionPrivateDnsZoneName}-link'
  location: 'global'
  properties: {
    registrationEnabled: false
    virtualNetwork: {
...
resource functionPvtEndpointDnsGroup 'Microsoft.Network/privateEndpoints/privateDnsZoneGroups@2021-05-01' = {
  name: functionPrivateDnsGroupName
  properties: {
    privateDnsZoneConfigs: [
      {
        name: '${functionPrivateDnsGroupName}/config'
        properties: {
